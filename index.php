  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <!-- <li><a class="nav-link scrollto active" href="#hero">Our Mission</a></li> -->
          ...
          <li><a class="nav-link scrollto" href="#dsda">Customer Access Portal</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1 style="text-align:center">We are the first to hug babies from all over the world</h1>
      ...
      <!-- <div class="container"> -->
        ...
        <!-- <div class="row"> -->
          ...
          <!-- <div class="col-lg-4 col-md-4 col-6"> -->
            <!-- <img src="assets/img/ertuncozcan.png" style="width:112px; height: 80px" class="img-fluid" alt="" data-aos="zoom-in"> -->
          <!-- </div> -->
              ...
              <div class="row">
                ...
                <div class="col-md-6 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    ...
                    <p><strong>Our Quality Standards</strong> Our productions ISO 9001:2008 and ISO 13485:2003 Standards.</p>
                  </div>
                </div>
          ...
          <div class="col-lg-3 col-md-6 mt-4 mt-md-0">
            <div class="info">
              ...
              <div>
                ...
                <p>Phone:(0312) 641 41 34 - Fax: (0312) 641 40 06</p>
              </div>
